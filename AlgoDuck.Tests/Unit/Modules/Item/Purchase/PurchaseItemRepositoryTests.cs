...
//             Id = Guid.NewGuid(),
//             Coins = 100,
//             Purchases = new List<Models.ItemOwnership>()
//         };
//
...
//         var item = await _context.Items.FirstAsync();
//         
//         user.Purchases.Add(new Models.ItemOwnership { ItemId = item.ItemId, UserId = user.Id });
//         await _context.SaveChangesAsync();
//         
//         var request = new PurchaseRequestInternalDto
//         {
...
namespace AlgoDuck.Tests.Unit.Modules.Item.Purchase;