...
namespace AlgoDuck.Tests.Unit.Modules.User.Commands.User.Preferences.SetEditorLayout;
...
public sealed class SetEditorLayoutHandlerTests
{
    ...
    public async Task HandleAsync_WhenUserIdEmpty_ThenThrowsValidationException()
    {
        ...
        var dto = new SetEditorLayoutDto { EditorThemeId = Guid.NewGuid() };
        var validator = CreateValidatorMock(dto);

        var handler = new SetEditorLayoutHandler(dbContext, validator.Object);
    ...
    public async Task HandleAsync_WhenLayoutMissing_ThenCreatesLayoutWithTheme()
    {
        ...
        var dto = new SetEditorLayoutDto { EditorThemeId = themeId };
        var validator = CreateValidatorMock(dto);
    ...
    static Mock<IValidator<SetEditorLayoutDto>> CreateValidatorMock(SetEditorLayoutDto dto)
    {
        var mock = new Mock<IValidator<SetEditorLayoutDto>>();
