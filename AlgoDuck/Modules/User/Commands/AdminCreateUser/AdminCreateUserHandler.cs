...
public sealed class AdminCreateUserHandler : IAdminCreateUserHandler
{
    private readonly UserManager<ApplicationUser> _userManager;
    private readonly IValidator<AdminCreateUserDto> _validator;

    public AdminCreateUserHandler(UserManager<ApplicationUser> userManager, IValidator<AdminCreateUserDto> validator)
    {
        _userManager = userManager;
        _validator = validator;
    }

    public async Task<AdminCreateUserResultDto> HandleAsync(AdminCreateUserDto dto, CancellationToken cancellationToken)
    {
        ...
        return new AdminCreateUserResultDto
        {
            UserId = user.Id,
