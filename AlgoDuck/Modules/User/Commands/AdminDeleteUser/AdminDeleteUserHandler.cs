...
public sealed class AdminDeleteUserHandler : IAdminDeleteUserHandler
{
    private readonly UserManager<ApplicationUser> _userManager;
    private readonly ApplicationCommandDbContext _db;

    public AdminDeleteUserHandler(UserManager<ApplicationUser> userManager, ApplicationCommandDbContext db)
    {
