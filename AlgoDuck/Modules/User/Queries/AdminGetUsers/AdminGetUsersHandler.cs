...
public sealed class AdminGetUsersHandler : IAdminGetUsersHandler
{
    private readonly IUserRepository _userRepository;
    private readonly ApplicationQueryDbContext _db;

    public AdminGetUsersHandler(IUserRepository userRepository, ApplicationQueryDbContext db)
    {
        _userRepository = userRepository;
        _db = db;
    }

    public async Task<PageData<AdminUserItemDto>> HandleAsync(AdminGetUsersDto query, CancellationToken cancellationToken)
    {
        ...
        var items = new List<AdminUserItemDto>(users.Count);
        ...
        return new PageData<AdminUserItemDto>
        {
            CurrPage = query.Page,
