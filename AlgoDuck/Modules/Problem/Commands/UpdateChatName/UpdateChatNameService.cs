...
{
    public Task<Result<UpdateChatNameResult, string>> UpdateChatName(UpdateChatNameDto dto,  CancellationToken cancellationToken = default);
}
...
{
    public async Task<Result<UpdateChatNameResult, string>> UpdateChatName(UpdateChatNameDto dto, CancellationToken cancellationToken = default)
    {
