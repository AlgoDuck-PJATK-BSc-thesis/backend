namespace AlgoDuck.Modules.Problem.Queries.GetProblemDetailsById.ProblemDtos;

public class ProblemDto(Guid problemId, string name, string description, DifficultyDto difficultyDto, CategoryDto categoryDto)
{
